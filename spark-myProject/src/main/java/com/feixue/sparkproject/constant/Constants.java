package com.feixue.sparkproject.constant;

/**
 *
 * 常量接口类
 *
 * 在正式的项目代码编写过程中，是完全严格按照大公司的coding标准来的，也就是说，
 * 在代码中，是不能出现任何hard code（硬编码）的字符，比如“张三”、“com.mysql.jdbc.Driver”等，
 * 所有这些东西，都需要通过常量来封装和使用，所以要创建常量接口类。
 *
 * @Author ：feixue
 * @Data : 17:52 2018/10/11
 */
